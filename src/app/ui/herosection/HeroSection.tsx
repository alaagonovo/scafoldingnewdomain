...
function HeroSection() {
  return (
    ...
    >
      ...
      <h2 className="text-white text-5xl font-[500] absolute top-[318px] left-[88px] leading-[66px]">
        Explore Our Expertly Designed Scaffolding
        <br /> Solutions. Built for Strength and Safety
      </h2>
      <p className="text-white text-[22px]  absolute top-[482px] left-[88px] leading-[33px] max-w-[521px]">
